...
import os
"""
    Argument parser for LLMs using pytorch + deepspeed
    This version keeps the args as a namespace instead of dict
    so that it can integrate with deepspeed
"""
...
def parse_arguments(deepspeed_args:bool=False):
    ...
    # par.add_argument('--deepspeed_config', type=str, default=None)
